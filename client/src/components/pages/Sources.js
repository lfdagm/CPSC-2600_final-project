                    ...
                    <table className="table">
                      ...
                      <tbody className="table-stripped">
                        ...
                        <tr>
                          <th scope="row">2</th>
                          <td>
                            A man driving a car with his hands on the steering
                            wheel
                          </td>
                          <td>Airam Dato-on</td>
                          <td>
                            <Link
                              to={
                                "https://www.pexels.com/photo/a-man-driving-a-car-with-his-hands-on-the-steering-wheel-15487492/"
                              }
                            >
                              Pexels
                            </Link>
                        ...
                        <tr>
                          ...
                          <td>
                            <Link
                              to={
                                "https://www.pexels.com/photo/photography-of-people-connecting-their-fingers-1023828/"
                              }
                            >
                              Pexels
                            </Link>
                        ...
                        <tr>
                          ...
                          <td>
                            <Link
                              to={
                                "https://unsplash.com/photos/persons-holding-leaves-during-daytime-mE5MBZX5sko"
                              }
                            >
                              Unsplash
                            </Link>
                        ...
                        <tr>
                          <th scope="row">5</th>
                          <td>
                            Young ethnic man in earbuds listening to music while
                            waiting for transport at contemporary subway station
                          </td>
                          <td>Andrea Piacquadio</td>
                          <td>
                            <Link
                              to={
                                "https://www.pexels.com/photo/young-ethnic-man-in-earbuds-listening-to-music-while-waiting-for-transport-at-contemporary-subway-station-3799205/"
                              }
                            >
                              Pexels
                            </Link>
                        ...
                        <tr>
                          ...
                          <td>
                            <Link
                              to={
                                "https://www.pexels.com/photo/a-woman-tutoring-a-young-student-8472987/"
                              }
                            >
                              Pexels
                            </Link>
